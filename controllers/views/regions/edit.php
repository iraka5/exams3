...
<body>
    <div class="header">
        <h1>BNGRC - Modifier la région</h1>
    </div>
    ...
    <div class="container">
        <div class="form-container">
            <h2>Modifier: <?= htmlspecialchars($region['nom']) ?></h2>
            
            <?php if (isset($_GET['error']) && $_GET['error'] == 1): ?>
                <div class="error">Le nom de la région est obligatoire.</div>
            <?php endif; ?>

            <form action="/exams3-main/exams3/regions/<?= $region['id'] ?>/update" method="POST">
                ...
                <a href="/exams3-main/exams3/regions" class="btn btn-secondary">Annuler</a>
            </form>
        </div>
    </div>
</body>
