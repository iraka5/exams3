...
<head>
    <meta charset="UTF-8">
    <title>Nouvelle Région - BNGRC</title>
    <style>
...
<body>
    <div class="header">
        <h1>BNGRC - Ajouter une région</h1>
    </div>
    ...
    <div class="container">
        <div class="card">
            ...
            <form method="post" action="<?= $base ?>/regions/create">
                <div class="form-group">
                    <label for="nom">Nom de la région</label>
                    <input type="text" id="nom" name="nom" placeholder="Ex: Analamanga, Atsinanana..." required>
                </div>

                <div class="actions">
                    <a href="<?= $base ?>/regions" class="btn btn-back">Annuler</a>
                    <button type="submit" class="btn btn-success">Créer la région</button>
                </div>
            </form>
        </div>
    </div>
